In the previous lesson, I separated the link **presentational components** from the filter link **container components** that is subscribed to the **Redux store** and that provides the data and the behavior for the link component it renders.
