...
```
What's going to happen is, because we have bound our note's state to our child ref here, whenever we update this endpoint, those changes are automatically going to be pushed through to our state. 
